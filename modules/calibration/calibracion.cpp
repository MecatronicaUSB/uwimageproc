/*********************************************************************/
/* File: calibración.cpp                                             */
/* Last Edition: 28/09/2015, 11:33 PM.                               */
/*********************************************************************/
/* Programmed by:                                                    */
/* Bernardo Aceituno C                                               */
/*********************************************************************/
/*Camera calibration program, takes the settings XML as input and    */
/*outputs a .XML file with the intrinsic camera coefficients.        */
/*Based on: camera_calibration.cpp OpenCV example                    */
...
int main(int argc, char* argv[]){
    ...
    //----------------releases the input file--------------------------------
    fs.release();


    //vector for the calibration points
    ...
    //obtains the calibration mode
    int mode = (s.inputType == Settings::IMAGE_LIST) ? CAPTURING : DETECTION;

    clock_t prevTimestamp = 0;

    //color for the reference points get detected
    const Scalar RED(0,0,255), GREEN(0,255,0);
    const char ESC_KEY = 27;

    //the first frame is read and the output video is created
    Mat view;
